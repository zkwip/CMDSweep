...
class TableGrid
{
    ...
    public Point this[int col, int row] => new(colPart[col].Start, rowPart[row].Start);
    public Point this[string col, int row] => new(colPart[col].Start, rowPart[row].Start);
    public Point this[int col, string row] => new(colPart[col].Start, rowPart[row].Start);
    public Point this[string col, string row] => new(colPart[col].Start, rowPart[row].Start);
